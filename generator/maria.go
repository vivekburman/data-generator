...
func MariaDBRelational() {
	...
	createUsersTableMariaDB(db)
	createSessionsTableMariaDB(db)
	createActivityTableMariaDB(db)
	insertRelationalDataMariaDB(db)
}

func createUsersTableMariaDB(db *sql.DB) {
	createTable := `
...
func createSessionsTableMariaDB(db *sql.DB) {
	createTable := `
...
func createActivityTableMariaDB(db *sql.DB) {
	createTable := `
...
func insertRelationalDataMariaDB(db *sql.DB) {
